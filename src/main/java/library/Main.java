    ...
    if (role == 1) {
      ...
      if (libraryManager.IsValidAdmin(email, password)) {
        ...
        while (continueadmin) {
          ...
          System.out.println("12. get unreturned books");
          ...
          switch (choice) {
            ...
            case 5:
              ...
              BookSearchService bookSearchByGenre =
                  new BookSearchService(books);
            ...
            case 6:
              ...
              BookSearchService bookSearchByAuthor =
                  new BookSearchService(books);
            ...
            case 11:
              ...
              break;
            case 12:
            	libraryManager.getunreturneBooks().forEach(ub -> {
					System.out.println("User: " + ub.getUser().getName() +
					                   ", Book: " + ub.getBook().getTitle() +
					                   ", Borrow Date: " + ub.getBorrowDate() +
					                   ", Return Date: " + ub.getReturnDate());
				});
      ...
      if (libraryManager.IsValidUser(email, password)) {
        RegularUser user =
            libraryManager.getUserByEmailAndPassword(email, password);
        ...
        while (continueUser) {
          ...
          System.out.println("5. Search Book by Genre");
          System.out.println("6.serach Book by Author");
          System.out.println("7. get borrowed books");
          ...
          switch (choice) {
            ...
            case 6:
              ...
              case 7:
            	  libraryManager.getborrowedBooks(user.getId()).forEach(b -> {System.out.println(b); });
            	  break;
        ...
        System.out.println(
            "u have not been registered yet or invalid email or password");
      }
